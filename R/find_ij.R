...
#' @export
find_ij <- function(ostype = .Platform$OS.type){
  if (ostype == "windows") {
    if (file.exists("C:\\Program Files\\ImageJ\\ij.jar") != T || file.exists("C:\\Program Files\\ImageJ\\jre\\bin\\java.exe") != T) {
